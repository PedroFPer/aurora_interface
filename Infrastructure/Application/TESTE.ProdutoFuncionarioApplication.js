...
window.addEventListener('DOMContentLoaded', async () => {
  ...
  try {
    ...
    document.getElementById('titulo_produto').placeholder = produto.nome;
    document.getElementById('preco_produto').placeholder = `R$ ${produto.precoUnitario.toFixed(2)}`;
    document.getElementById('parcelamento').innerText = `Em até 3 vezes de R$  ${parcelamento(produto.precoUnitario.toFixed(2))}`;
    document.getElementById('descricao_produto').placeholder = produto.descricao;
